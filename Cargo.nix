...
rec {
  ...
  workspaceMembers = {
    "engenho-promessa" = rec {
      packageId = "engenho-promessa";
    ...
    "promessa-controller-common" = rec {
      packageId = "promessa-controller-common";
      build = internal.buildRustCrateWithFeatures {
        packageId = "promessa-controller-common";
      };
    ...
    "reconciler-engine" = rec {
      packageId = "reconciler-engine";
      build = internal.buildRustCrateWithFeatures {
        packageId = "reconciler-engine";
      };
    ...
    "security-controller" = rec {
      packageId = "security-controller";
      build = internal.buildRustCrateWithFeatures {
        packageId = "security-controller";
      };
    ...
    "validation-controllers" = rec {
      packageId = "validation-controllers";
      build = internal.buildRustCrateWithFeatures {
        packageId = "validation-controllers";
      };
    ...
    "validation-events" = rec {
      packageId = "validation-events";
      build = internal.buildRustCrateWithFeatures {
        packageId = "validation-events";
      };
    ...
    "validation-store" = rec {
      packageId = "validation-store";
      build = internal.buildRustCrateWithFeatures {
        packageId = "validation-store";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dynamic-schema" "email-validator" "fast_chemail" "graphiql" "handlebars" "playground" "tempfile" ];
      };
      ...
      "async-nats" = rec {
        ...
        version = "0.42.0";
        edition = "2021";
        sha256 = "102i652wbzl8fjycrsk9ni4dg47paqvfk3z2li644mm995nxmxh8";
        libName = "async_nats";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "ring" "server_2_10" "server_2_11" ];
      };
      "async-stream" = rec {
      ...
      "axum 0.8.9" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tokio-tungstenite";
            packageId = "tokio-tungstenite 0.29.0";
            optional = true;
          }
          {
            name = "tower";
      ...
      "cofre-types" = rec {
        crateName = "cofre-types";
        version = "0.1.0";
        edition = "2024";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/cofre";
          rev = "fb9eaf9e13c22054d91ea6431c09d246d34028a8";
          sha256 = "16kdl43d2a8v5fzpd6kvdcx3987mipy4b84m4dbmxdjr04y7796r";
        };
        libName = "cofre_types";
        authors = [
          "pleme-io"
      ...
      "engenho-promessa" = rec {
        crateName = "engenho-promessa";
        version = "0.1.1";
        edition = "2024";
        crateBin = [
          {
            name = "engenho-promessa";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho-promessa; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
          ...
          }
          {
            name = "kube";
            packageId = "kube";
            features = [ "derive" "runtime" "client" "rustls-tls" "runtime" "client" ];
          }
          {
            name = "promessa-controller-common";
            packageId = "promessa-controller-common";
          }
          {
            name = "promessa-types";
            packageId = "promessa-types";
          }
          {
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-multi-thread" "macros" "sync" "time" "fs" "io-std" "io-util" "signal" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
      ...
      "private-push" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./private-push; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
          ...
          }
          {
            name = "kube";
            packageId = "kube";
            features = [ "derive" "runtime" "client" "rustls-tls" ];
          }
          {
            name = "reqwest";
            packageId = "reqwest";
      ...
      "promessa-controller-common" = rec {
        crateName = "promessa-controller-common";
        version = "0.1.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./promessa-controller-common; };
        libName = "promessa_controller_common";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "promessa-types" = rec {
        crateName = "promessa-types";
        version = "0.1.0";
        edition = "2024";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/promessa";
          rev = "12b675a80863a22ba8950d4799b970764da2d358";
          sha256 = "1d48bnl0sw1zrlhm0p15mffxzm31r8nnqw93x3qvsz35kwrw3830";
        };
        libName = "promessa_types";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "reconciler-engine" = rec {
        crateName = "reconciler-engine";
        version = "0.1.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./reconciler-engine; };
        libName = "reconciler_engine";
        authors = [
          "pleme-io"
        ];
        dependencies = [
        ...
        devDependencies = [
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-multi-thread" "macros" "sync" "time" "fs" "io-std" "io-util" "signal" "macros" "rt-multi-thread" ];
          }
          {
            name = "wiremock";
            packageId = "wiremock";
      ...
      "scanner-catalog" = rec {
        crateName = "scanner-catalog";
        version = "0.1.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./scanner-catalog; };
        libName = "scanner_catalog";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "security-controller" = rec {
        crateName = "security-controller";
        version = "0.1.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./security-controller; };
        libName = "security_controller";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "sqlx" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "_sqlite" "bigdecimal" "chrono" "json" "postgres" "runtime-tokio" "runtime-tokio-rustls" "rust_decimal" "sqlite" "sqlx-postgres" "sqlx-sqlite" "time" "tls-rustls-ring" "tls-rustls-ring-webpki" "uuid" ];
      };
      "sqlx-core" = rec {
        crateName = "sqlx-core";
        version = "0.8.6";
      ...
      "sqlx-macros" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "_tls-rustls-ring-webpki" "bigdecimal" "chrono" "default" "json" "postgres" "rust_decimal" "sqlite" "time" "uuid" ];
      };
      "sqlx-macros-core" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "_sqlite" "_tls-rustls-ring-webpki" "bigdecimal" "chrono" "default" "json" "postgres" "rust_decimal" "sqlite" "sqlx-postgres" "sqlx-sqlite" "time" "tokio" "uuid" ];
      };
      "sqlx-mysql" = rec {
      ...
      "tokio-util" = rec {
        ...
        resolvedDefaultFeatures = [ "codec" "compat" "default" "futures-io" "io" "slab" "time" ];
      };
      ...
      "tower 0.5.3" = rec {
        ...
        resolvedDefaultFeatures = [ "buffer" "filter" "futures-core" "futures-util" "log" "make" "pin-project-lite" "retry" "sync_wrapper" "timeout" "tokio" "tokio-util" "tracing" "util" ];
      };
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "auth" "base64" "cors" "default" "follow-redirect" "futures-util" "map-response-body" "mime" "tower" "trace" "tracing" "validate-request" ];
      };
      "tower-layer" = rec {
      ...
      "validation-api" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./validation-api; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "validation-controllers" = rec {
        crateName = "validation-controllers";
        version = "0.1.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./validation-controllers; };
        libName = "validation_controllers";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "validation-crds" = rec {
        crateName = "validation-crds";
        version = "0.1.1";
        edition = "2024";
        crateBin = [
          {
            name = "validation-crd-export";
            path = "src/bin/export.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./validation-crds; };
        libName = "validation_crds";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "validation-events" = rec {
        crateName = "validation-events";
        version = "0.1.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./validation-events; };
        libName = "validation_events";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "validation-store" = rec {
        crateName = "validation-store";
        version = "0.1.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./validation-store; };
        libName = "validation_store";
        authors = [
          "pleme-io"
        ];
        dependencies = [
          ...
          }
          {
            name = "sea-orm";
            packageId = "sea-orm";
            features = [ "sqlx-sqlite" "sqlx-postgres" "runtime-tokio-rustls" "macros" "with-chrono" "with-uuid" "with-json" ];
          }
          {
            name = "serde";
            packageId = "serde";
